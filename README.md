...
1.	Area one - this app is deals with human trafficking and you need feedback on
    your roadmap and feature list from the private sector / NGOs
2.	Area two - you want people to opt-in and try using your staging app at 
    staging.project-name.com and report any bugs via a form
3.	Area three - here is the zoom link to our end-of sprint webinar, join and 
    provide feedback as a stakeholder if you can
...
|![site map detailed](./fumanaImg/fumana_logo_1.png)|Front-End Dev|Chaibo Seopa|South Africa |Cape Town|Github|
